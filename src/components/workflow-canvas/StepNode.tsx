...
export function StepNode({ data }: NodeProps) {
  ...
  return (
    <div
      className={cn(
        'bg-white rounded-xl border transition-all w-[300px] cursor-pointer',
        isSelected
    ...
    >
      ...
      <div className="flex items-center justify-center py-1.5 border-b border-border cursor-grab active:cursor-grabbing">
